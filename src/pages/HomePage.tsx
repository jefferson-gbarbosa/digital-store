   ...
   <main  className="bg-[#F9F8FE]">
      ...
      <Section
        ...
        <div className=" flex gap-4 pt-6">
          <div className="relative w-[405px] h-[251px] p-6 flex items-center justify-between max-w-3xl mx-auto">
            <div className="absolute inset-0 bg-[url('/collection-1.png')] bg-cover bg-bottom-right rounded-xl w-full"></div>
            <div className="relative">
              <span className="w-[96px] h-[32px] flex gap-2.5 bg-[#E7FF86] text-[#474747] font-semibold text-sm py-1.5 px-4 rounded-3xl absolute -top-22 left-0">
                30% OFF
              </span>
            ...
            <div className="flex gap-5 pt-10">
                <div className="relative w-[573px]">
                  <div className="w-[400px] h-[400px] rounded-full"
                    style={{background: 'linear-gradient(180deg, rgba(66, 0, 255, 0.25) -40.67%, rgba(255, 255, 255, 0) 100%)'}}
                  >
                  </div>
                  <img src="/tenis-1.png" alt="" className="w-[573px] h-[330px] absolute top-10 -left-25"/>
                </div>
                <div className="max-w-[695px]">
                    <span className="text-primary font-bold text-base leading-6 tracking-[0.75px] block mb-5">
                        Oferta especial
                    </span>
                    <h1 className="text-[#1F1F1F] font-extrabold text-[64px] leading-[66px] tracking-[1px] mb-6">
                      Air Jordan edição de colecionador
                    </h1>
                    <p className="text-dark-gray-2 font-normal text-base leading-7 tracking-[0.75px] mb-10">
