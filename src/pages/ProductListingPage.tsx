    ...
    <div className="bg-[#f5f5f5] w-full relative pt-5 overflow-x-hidden">
      <Section titleAlign="left">
        ...
        <h2 className="text-xl font-semibold px-4 mb-4 md:ml-6">
          Resultados para “{searchTerm}” <span className="font-normal">– {sortedProducts.length} produtos</span>
        </h2>
        ...
        <div className="flex gap-8 px-8 py-10 max-w-7xl h-full mx-auto flex-col-reverse md:flex-row relative">
          ...
          <aside className="hidden md:block w-[308px] flex-shrink-0 space-y-8 rounded-sm">
            <div className="bg-white p-8 flex flex-col gap-2">
              ...
              <FilterGroup title="Marca" inputType="checkbox" options={[{ text: "Adidas" }, { text: "Balenciaga" }, { text: "K-Swiss" }, { text: "Nike" }, { text: "Puma" }]} />
              <FilterGroup title="Categoria" inputType="checkbox" options={[{ text: "Esporte e lazer" }, { text: "Casual" }, { text: "Utilitário" }, { text: "Corrida" }]} />
              <FilterGroup title="Gênero" inputType="radio" options={[{ text: "Masculino" }, { text: "Feminino" }, { text: "Unissex" }]} />
              <FilterGroup title="Estado" inputType="radio" options={[{ text: "Novo" }, { text: "Usado" }]} />
            </div>
          </aside>

          {/* Sidebar mobile com animação */}
          <aside className={`fixed top-14 inset-0 z-50 flex md:hidden ${isSidebarOpen ? '' : 'pointer-events-none'}`}>
            {/* Overlay */}
            <div
            ...
            >
              ...
              <h2 className="text-dark-gray-2 mt-4 mb-2 font-bold text-base leading-6 tracking-[0.75px]">Filtrar por</h2>
              <hr className="border-light-gray-2 mb-4" />
              <FilterGroup title="Marca" inputType="checkbox" options={[{ text: "Adidas" }, { text: "Balenciaga" }, { text: "K-Swiss" }, { text: "Nike" }, { text: "Puma" }]} />
              <FilterGroup title="Categoria" inputType="checkbox" options={[{ text: "Esporte e lazer" }, { text: "Casual" }, { text: "Utilitário" }, { text: "Corrida" }]} />
              <FilterGroup title="Gênero" inputType="radio" options={[{ text: "Masculino" }, { text: "Feminino" }, { text: "Unissex" }]} />
